...
class Ui_frm_popup_department(object):
    def setupUi(self, frm_popup_department):
        frm_popup_department.setObjectName("frm_popup_department")
        frm_popup_department.resize(1122, 388)
        self.gridLayout = QtWidgets.QGridLayout(frm_popup_department)
        self.gridLayout.setContentsMargins(-1, 11, -1, 11)
        self.gridLayout.setVerticalSpacing(0)
        self.gridLayout.setObjectName("gridLayout")
        self.frame = QtWidgets.QFrame(parent=frm_popup_department)
...
"font: 18pt \"Phetsarath OT\";")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Project\\new_exim_device\\Department\\../../../Users/AlexP/PycharmProjects/pythonProject/PythonPOS/icon/search-alt-regular-60.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"color: rgb(255, 0, 0);")
        ...
        self.label_22.setGeometry(QtCore.QRect(20, 60, 161, 41))
        self.label_22.setStyleSheet("font: 18pt \"Phetsarath OT\";\n"
"color: rgb(255, 213, 126);\n"
"")
        self.label_22.setObjectName("label_22")
        self.txt_department_name = QtWidgets.QLineEdit(parent=self.frame)
        self.txt_department_name.setGeometry(QtCore.QRect(210, 60, 411, 41))
        font = QtGui.QFont()
        font.setFamily("Phetsarath OT")
        font.setPointSize(12)
        font.setBold(False)
        ...
        font.setWeight(50)
        font.setStyleStrategy(QtGui.QFont.StyleStrategy.PreferAntialias)
        self.txt_department_name.setFont(font)
        self.txt_department_name.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.txt_department_name.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);\n"
"font: 12pt \"Phetsarath OT\";")
        self.txt_department_name.setText("")
        self.txt_department_name.setDragEnabled(False)
        self.txt_department_name.setPlaceholderText("")
        self.txt_department_name.setCursorMoveStyle(QtCore.Qt.CursorMoveStyle.LogicalMoveStyle)
        self.txt_department_name.setObjectName("txt_department_name")
        self.gridLayout.addWidget(self.frame, 0, 0, 1, 1)
        self.gridLayout.setRowStretch(0, 2)

        self.retranslateUi(frm_popup_department)
        QtCore.QMetaObject.connectSlotsByName(frm_popup_department)

    def retranslateUi(self, frm_popup_department):
        _translate = QtCore.QCoreApplication.translate
        frm_popup_department.setWindowTitle(_translate("frm_popup_department", "Form Department"))
        self.label_18.setText(_translate("frm_popup_department", "Description"))
        self.btn_insert.setText(_translate("frm_popup_department", " ເພີ່ມຂໍ້ມູນ"))
        self.btn_edit.setText(_translate("frm_popup_department", "ແກ້ໄຂ"))
        self.btn_clear.setText(_translate("frm_popup_department", "ລ້າງ"))
        self.btn_cancel.setText(_translate("frm_popup_department", "ຍົກເລີກ"))
        self.label_22.setText(_translate("frm_popup_department", "Department"))
