...
class Ui_frm_popup_company(object):
    def setupUi(self, frm_popup_company):
        frm_popup_company.setObjectName("frm_popup_company")
        frm_popup_company.resize(1122, 389)
        self.gridLayout = QtWidgets.QGridLayout(frm_popup_company)
        self.gridLayout.setHorizontalSpacing(7)
        self.gridLayout.setVerticalSpacing(0)
        self.gridLayout.setObjectName("gridLayout")
        self.frame = QtWidgets.QFrame(parent=frm_popup_company)
...
"font: 18pt \"Phetsarath OT\";")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Project\\new_exim_device\\Company\\../../../Users/AlexP/PycharmProjects/pythonProject/PythonPOS/icon/search-alt-regular-60.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        self.txt_company_name = QtWidgets.QLineEdit(parent=self.frame)
        self.txt_company_name.setGeometry(QtCore.QRect(210, 60, 411, 41))
        font = QtGui.QFont()
        font.setFamily("Phetsarath OT")
        font.setPointSize(12)
        font.setBold(False)
        ...
        font.setWeight(50)
        font.setStyleStrategy(QtGui.QFont.StyleStrategy.PreferAntialias)
        self.txt_company_name.setFont(font)
        self.txt_company_name.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.txt_company_name.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);\n"
"font: 12pt \"Phetsarath OT\";")
        self.txt_company_name.setText("")
        self.txt_company_name.setDragEnabled(False)
        self.txt_company_name.setPlaceholderText("")
        self.txt_company_name.setCursorMoveStyle(QtCore.Qt.CursorMoveStyle.LogicalMoveStyle)
        self.txt_company_name.setObjectName("txt_company_name")
        self.gridLayout.addWidget(self.frame, 0, 0, 1, 1)
        self.gridLayout.setRowStretch(0, 2)

        self.retranslateUi(frm_popup_company)
        QtCore.QMetaObject.connectSlotsByName(frm_popup_company)

    def retranslateUi(self, frm_popup_company):
        _translate = QtCore.QCoreApplication.translate
        frm_popup_company.setWindowTitle(_translate("frm_popup_company", "Form Company"))
        self.label_18.setText(_translate("frm_popup_company", "Description"))
        self.btn_insert.setText(_translate("frm_popup_company", " ເພີ່ມຂໍ້ມູນ"))
        self.btn_edit.setText(_translate("frm_popup_company", "ແກ້ໄຂ"))
        self.btn_clear.setText(_translate("frm_popup_company", "ລ້າງ"))
        self.btn_cancel.setText(_translate("frm_popup_company", "ຍົກເລີກ"))
        self.label_22.setText(_translate("frm_popup_company", "Company"))
