...
class Ui_frm_popup_device_location(object):
    def setupUi(self, frm_popup_device_location):
        frm_popup_device_location.setObjectName("frm_popup_device_location")
        frm_popup_device_location.resize(1122, 478)
        self.gridLayout = QtWidgets.QGridLayout(frm_popup_device_location)
        self.gridLayout.setContentsMargins(-1, 11, -1, 11)
        self.gridLayout.setVerticalSpacing(0)
        self.gridLayout.setObjectName("gridLayout")
        self.frame = QtWidgets.QFrame(parent=frm_popup_device_location)
...
"font: 18pt \"Phetsarath OT\";")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Project\\new_exim_device\\Device_location\\../../../Users/AlexP/PycharmProjects/pythonProject/PythonPOS/icon/search-alt-regular-60.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.txt_address.setGeometry(QtCore.QRect(250, 110, 391, 41))
        font = QtGui.QFont()
...
"")
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(520, 260, 541, 80))
...
"")
        ...
        self.txt_device_location = QtWidgets.QLineEdit(parent=self.frame)
        self.txt_device_location.setGeometry(QtCore.QRect(260, 60, 381, 41))
        font = QtGui.QFont()
        font.setFamily("Phetsarath OT")
        font.setPointSize(12)
        font.setBold(False)
        ...
        font.setWeight(50)
        font.setStyleStrategy(QtGui.QFont.StyleStrategy.PreferAntialias)
        self.txt_device_location.setFont(font)
        self.txt_device_location.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.txt_device_location.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);\n"
"font: 12pt \"Phetsarath OT\";")
        self.txt_device_location.setText("")
        self.txt_device_location.setDragEnabled(False)
        self.txt_device_location.setPlaceholderText("")
        self.txt_device_location.setCursorMoveStyle(QtCore.Qt.CursorMoveStyle.LogicalMoveStyle)
        self.txt_device_location.setObjectName("txt_device_location")
        self.txt_remark = QtWidgets.QLineEdit(parent=self.frame)
        self.txt_remark.setGeometry(QtCore.QRect(240, 160, 401, 41))
        font = QtGui.QFont()
        font.setFamily("Phetsarath OT")
        font.setPointSize(12)
        font.setBold(False)
...
"font: 12pt \"Phetsarath OT\";")
        ...
        self.label_19.setGeometry(QtCore.QRect(20, 160, 161, 41))
...
"")
        ...
        self.retranslateUi(frm_popup_device_location)
        QtCore.QMetaObject.connectSlotsByName(frm_popup_device_location)

    def retranslateUi(self, frm_popup_device_location):
        _translate = QtCore.QCoreApplication.translate
        frm_popup_device_location.setWindowTitle(_translate("frm_popup_device_location", "Form Device location"))
        self.label_18.setText(_translate("frm_popup_device_location", "Address"))
        self.btn_insert.setText(_translate("frm_popup_device_location", " ເພີ່ມຂໍ້ມູນ"))
        self.btn_edit.setText(_translate("frm_popup_device_location", "ແກ້ໄຂ"))
        self.btn_clear.setText(_translate("frm_popup_device_location", "ລ້າງ"))
        self.btn_cancel.setText(_translate("frm_popup_device_location", "ຍົກເລີກ"))
        self.label_22.setText(_translate("frm_popup_device_location", "Device Location"))
        self.label_19.setText(_translate("frm_popup_device_location", "Description"))
