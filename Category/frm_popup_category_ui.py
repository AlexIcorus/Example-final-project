...
class Ui_frm_popup_category(object):
    def setupUi(self, frm_popup_category):
        frm_popup_category.setObjectName("frm_popup_category")
        frm_popup_category.resize(1122, 388)
        self.gridLayout = QtWidgets.QGridLayout(frm_popup_category)
        self.gridLayout.setContentsMargins(-1, 11, -1, 11)
        self.gridLayout.setVerticalSpacing(0)
        self.gridLayout.setObjectName("gridLayout")
        self.frame = QtWidgets.QFrame(parent=frm_popup_category)
...
"font: 18pt \"Phetsarath OT\";")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Project\\new_exim_device\\Category\\../../../Users/AlexP/PycharmProjects/pythonProject/PythonPOS/icon/search-alt-regular-60.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        self.txt_category_name = QtWidgets.QLineEdit(parent=self.frame)
        self.txt_category_name.setGeometry(QtCore.QRect(210, 60, 411, 41))
        font = QtGui.QFont()
        font.setFamily("Phetsarath OT")
        font.setPointSize(12)
        font.setBold(False)
        ...
        font.setWeight(50)
        font.setStyleStrategy(QtGui.QFont.StyleStrategy.PreferAntialias)
        self.txt_category_name.setFont(font)
        self.txt_category_name.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.txt_category_name.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);\n"
"font: 12pt \"Phetsarath OT\";")
        self.txt_category_name.setText("")
        self.txt_category_name.setDragEnabled(False)
        self.txt_category_name.setPlaceholderText("")
        self.txt_category_name.setCursorMoveStyle(QtCore.Qt.CursorMoveStyle.LogicalMoveStyle)
        self.txt_category_name.setObjectName("txt_category_name")
        self.gridLayout.addWidget(self.frame, 0, 0, 1, 1)
        self.gridLayout.setRowStretch(0, 2)

        self.retranslateUi(frm_popup_category)
        QtCore.QMetaObject.connectSlotsByName(frm_popup_category)

    def retranslateUi(self, frm_popup_category):
        _translate = QtCore.QCoreApplication.translate
        frm_popup_category.setWindowTitle(_translate("frm_popup_category", "Form Category"))
        self.label_18.setText(_translate("frm_popup_category", "Description"))
        self.btn_insert.setText(_translate("frm_popup_category", " ເພີ່ມຂໍ້ມູນ"))
        self.btn_edit.setText(_translate("frm_popup_category", "ແກ້ໄຂ"))
        self.btn_clear.setText(_translate("frm_popup_category", "ລ້າງ"))
        self.btn_cancel.setText(_translate("frm_popup_category", "ຍົກເລີກ"))
        self.label_22.setText(_translate("frm_popup_category", "Category"))
