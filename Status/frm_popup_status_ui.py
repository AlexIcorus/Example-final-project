...
class Ui_frm_popup_status(object):
    def setupUi(self, frm_popup_status):
        frm_popup_status.setObjectName("frm_popup_status")
        frm_popup_status.resize(1122, 389)
        self.gridLayout = QtWidgets.QGridLayout(frm_popup_status)
        self.gridLayout.setHorizontalSpacing(7)
        self.gridLayout.setVerticalSpacing(0)
        self.gridLayout.setObjectName("gridLayout")
        self.frame = QtWidgets.QFrame(parent=frm_popup_status)
...
"font: 18pt \"Phetsarath OT\";")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Project\\new_exim_device\\Status\\../../../Users/AlexP/PycharmProjects/pythonProject/PythonPOS/icon/search-alt-regular-60.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        self.txt_status_name = QtWidgets.QLineEdit(parent=self.frame)
        self.txt_status_name.setGeometry(QtCore.QRect(210, 60, 411, 41))
        font = QtGui.QFont()
        font.setFamily("Phetsarath OT")
        font.setPointSize(12)
        font.setBold(False)
        ...
        font.setWeight(50)
        font.setStyleStrategy(QtGui.QFont.StyleStrategy.PreferAntialias)
        self.txt_status_name.setFont(font)
        self.txt_status_name.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.txt_status_name.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);\n"
"font: 12pt \"Phetsarath OT\";")
        self.txt_status_name.setText("")
        self.txt_status_name.setDragEnabled(False)
        self.txt_status_name.setPlaceholderText("")
        self.txt_status_name.setCursorMoveStyle(QtCore.Qt.CursorMoveStyle.LogicalMoveStyle)
        self.txt_status_name.setObjectName("txt_status_name")
        self.gridLayout.addWidget(self.frame, 0, 0, 1, 1)
        self.gridLayout.setRowStretch(0, 2)

        self.retranslateUi(frm_popup_status)
        QtCore.QMetaObject.connectSlotsByName(frm_popup_status)

    def retranslateUi(self, frm_popup_status):
        _translate = QtCore.QCoreApplication.translate
        frm_popup_status.setWindowTitle(_translate("frm_popup_status", "Form Status"))
        self.label_18.setText(_translate("frm_popup_status", "Description"))
        self.btn_insert.setText(_translate("frm_popup_status", " ເພີ່ມຂໍ້ມູນ"))
        self.btn_edit.setText(_translate("frm_popup_status", "ແກ້ໄຂ"))
        self.btn_clear.setText(_translate("frm_popup_status", "ລ້າງ"))
        self.btn_cancel.setText(_translate("frm_popup_status", "ຍົກເລີກ"))
        self.label_22.setText(_translate("frm_popup_status", "Status Name"))
